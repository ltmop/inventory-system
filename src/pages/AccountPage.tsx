...
export default function AccountPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="rounded-xl border border-lake-100 bg-lake-50/70 px-5 py-4 dark:border-slate-700 dark:bg-slate-800/70">
        <div className="flex items-start gap-3">
          <KeyRound className="mt-0.5 size-5 shrink-0 text-lake-600 dark:text-lake-300" />
          <div className="text-sm leading-relaxed text-slate-700 dark:text-slate-200">
            <div className="font-bold text-lake-800 dark:text-lake-300">多台电脑共用一套数据，怎么操作：</div>
            <div className="mt-1 space-y-1 text-slate-600 dark:text-slate-300">
              ...
              <div className="rounded-lg bg-lake-50 px-2.5 py-2 text-xs text-lake-700 dark:bg-slate-800 dark:text-lake-300">※ 忘了账号密码？<b>数据不会丢</b>——您的库存保存在本机、随时可用（本地优先）；忘密码只影响「多台电脑同步 + 云端备份」的找回，可在登录页点「忘记密码」查看恢复方法，或注册新账号重新同步。</div>
            </div>
          </div>
        </div>
      </div>
